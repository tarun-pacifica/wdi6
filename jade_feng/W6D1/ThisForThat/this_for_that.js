...
var playGame = confirm("Do you want to play this game?");

while (playGame == true) {

	var randomThis = function() {
		This = _this[Math.floor(Math.random()*_this.length)];
		return This;
	}

	var randomThat = function() {
		That = _that[Math.floor(Math.random()*_that.length)];
		return That;
	}
	alert("So.... your startup is basically like a like a "+ randomThis() +" for "+ randomThat() +"?");

	playGame = confirm("Do you want to play this game?");
