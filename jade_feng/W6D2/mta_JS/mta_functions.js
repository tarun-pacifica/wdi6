...
var train_action = function(onboarding_line, onboarding_station, disembarking_line, disembarking_station ) {
	// debugger
	var station_number_embarking = mta[onboarding_line].indexOf(onboarding_station)
	var station_number_disembarking = mta[disembarking_line].indexOf(disembarking_station)
	...
	console.log("You need to pass through " + num_of_stations_abs + " stations from " + onboarding_station + " to " + disembarking_station)
...
if (first_line === second_line) {
	...
	train_action(first_line_name, first_station, second_line_name, second_station);

	}
} else if (first_station === "UNION SQUARE") {
	
	console.log("Does not make sense for you to change trains if you're boarding at Union Square.")
	train_action(second_line_name, first_station, second_line_name, second_station);


} else if (second_station === "UNION SQUARE") {
	
	console.log("Why are you changing trains when you're getting off at Union Square?")
	train_action(first_line_name, first_station, first_line_name, second_station);
	...
	console.log("Probably makes more sense for you to walk. Don't bother catching the subway.")
		...
		// EMBARKING STATION
		train_action(first_line_name, first_station, first_line_name, "UNION SQUARE");
		...
		// Calculating the total number of stations to pass through
		var num_of_stations_embarking_abs = Math.abs(mta[first_line_name].indexOf(first_station) - mta[first_line_name].indexOf("UNION SQUARE"))
		var num_of_stations_disembarking_abs = Math.abs(mta[second_line_name].indexOf("UNION SQUARE") - mta[second_line_name].indexOf(second_station))
